...
from rembg_dataset import TestDataset, MaskBaseDataset, MaskMultiLabelDataset
...
def inference(data_dir, model_dir, output_dir, args):
    ...
    with torch.no_grad():
        for idx, images in enumerate(loader):
            ...
            pred = MaskMultiLabelDataset.encode_multi_class(mask_preds, gender_preds, age_preds)
            preds.extend(pred.cpu().numpy())

    info['ans'] = preds
    save_path = os.path.join(output_dir, f'multi-labeling-submission.csv')
